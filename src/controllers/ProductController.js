...
module.exports = {
  ...
  createProduct: async (req, res) => {
    try {
      const {
        nome,
        id_categoria, // Alterado de 'categoria'
        quantidade_estoque,
        preco_compra,
        preco_venda
      } = req.body;

      // Assumindo que req.userId é populado por um middleware de autenticação
      const id_usuario_criador = req.userId;

      if (!nome || !id_categoria || quantidade_estoque == null || preco_compra == null || preco_venda == null) {
  ...
  updateProduct: async (req, res) => {
    try {
      ...
      // Se 'categoria' for enviada, mapeie para 'id_categoria'
